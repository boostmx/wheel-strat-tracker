        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <PasswordInput id="newPassword" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="At least 8 characters" />
            </div>
            <div className="space-y-1.5">
          ...
          <div className={cn("flex justify-end pt-1", newPassword && confirmPassword && newPassword !== confirmPassword && "relative")}>
